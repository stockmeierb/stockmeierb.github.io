_Original docs from [timlrx/tailwind-nextjs-starter-blog](https://github.com/timlrx/tailwind-nextjs-starter-blog/)_
...
`data/bs-logo.png` - replace with your own logo.

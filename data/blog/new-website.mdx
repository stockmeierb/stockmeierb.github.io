...
If this website looks like it's still in draft, congratulations! You have been granted early access to a beta build of **Brett Online**. We hope to reach 1.0 by mid-2023.

[next-ts-starter]: https://github.com/stockmeierb/nextjs-mdx-themeui-ts-starter "My previous blog's starter"
[nextjs]: https://nextjs.org
[typescript]: https://www.typescriptlang.org/
[repo]: https://github.com/stockmeierb/stockmeierb.github.io/tree/main#using-this-base

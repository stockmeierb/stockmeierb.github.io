...
# Introduction
This was a weird, hard to parse [chapter](https://nextjs.org/learn/dashboard-app/optimizing-fonts-images) for me. I guess I've never thought about post optimization before. And the added Tailwind only made it harder to get a handle of.
